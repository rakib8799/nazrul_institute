            ...
            if ($password === $confirm_password) {
                try {
                    ...
                    if ($count > 0) {
                        ...
                        $insert_data = "INSERT INTO `author_information`(`author_name`,`author_email`, `author_contact_no`,`author_password`,`author_role`,`verification_code`, `email_verified_at`) VALUES ('$name','$email','$contact','$encrypted_password','$role_as','$verification_code','$current_time')";
            ...
            <div class="card rounded m-auto py-4 px-5 shadow">
                <form action="" method="post" onsubmit="return formData()">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="role_as" id="role_as" onselect="validateRole()" required>
