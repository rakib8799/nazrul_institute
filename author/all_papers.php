                ...
                <div class="table-responsive">
                    <table id="table" class="table table-bordered table-hover text-center">
                        ...
                        <tbody>
                            ...
                            $select_from_new_paper = "SELECT * FROM project_submission_student WHERE `researcher_author_id` = '$researcher_author_id'";
                ...
                <div class="table-responsive">
                    <table id="table" class="table table-bordered table-hover text-center">
                        ...
                        <tbody>
                            ...
                            $select_from_new_paper = "SELECT * FROM project_submission_teacher WHERE advisor_author_id='$advisor_author_id'";
                            $run_select_from_new_paper = mysqli_query($conn, $select_from_new_paper);
                            $serial_no = 1;
                            if (mysqli_num_rows($run_select_from_new_paper) > 0) {
                                while ($row = mysqli_fetch_assoc($run_select_from_new_paper)) {
