                ...
                <form action="" method="POST" onsubmit="return confirmPaper()">
                    ...
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="researcher_salaryExp" id="researcher_salaryExp" placeholder="আপনার সম্মানীর পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="researcher_supervisorSalaryExp">গবেষণা তত্ত্বাবধায়কের সম্মানী (মোট টাকার ১৫%)<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="researcher_supervisorSalaryExp" id="researcher_supervisorSalaryExp" placeholder="গবেষণা তত্ত্বাবধায়কের সম্মানীর পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="researcher_fieldWorkExp" id="researcher_fieldWorkExp" placeholder="মাঠ পর্যায়ে গবেষণার ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="researcher_seminarExp" id="researcher_seminarExp" placeholder="সেমিনার আয়োজনের জন্য ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="researcher_travelExp">ভ্রমণ ব্যয়/যাতায়াত ব্যয়<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="researcher_travelExp" id="researcher_travelExp" placeholder="ভ্রমণ ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="researcher_itemsExp">মনোহারী দ্রব্যাদি ক্রয় খাতে ব্যয় (সর্বোচ্চ ২০০০ পর্যন্ত)<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="researcher_itemsExp" id="researcher_itemsExp" placeholder="মনোহারী দ্রব্যাদি ক্রয় খাতের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="researcher_reportExp">প্রতিবেদন প্রণয়ন ও বাঁধাই ব্যয় (সর্বোচ্চ ৫০০০ পর্যন্ত)<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="researcher_reportExp" id="researcher_reportExp" placeholder="প্রতিবেদন প্রণয়ন ও বাঁধাই ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="researcher_extraExp">বিবিধ (সর্বোচ্চ ২০০০ পর্যন্ত)<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="researcher_extraExp" id="researcher_extraExp" placeholder="আরো কোনো খাতে ব্যয় হলে তার পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="researcher_sixMonthTotalExp" id="researcher_sixMonthTotalExp" placeholder="ছয় মাস মেয়াদী প্রকল্পের মোট ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div>
            ...
            <div class="card pt-5 pb-4 shadow mb-5 px-md-5 px-3 bg-body rounded">
                <form action="" method="POST" onsubmit="return confirmPaper()">
                    ...
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_project_salaryExp" id="advisor_project_salaryExp" placeholder="প্রকল্প পরিচালকের সম্মানীর পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="advisor_assisstantSalaryExp">গবেষণা সহকারী/শ্রমিকের মাসিক ভাতা/মজুরী (যদি থাকে)<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_assisstantSalaryExp" id="advisor_assisstantSalaryExp" placeholder="গবেষণা তত্ত্বাবধায়কের সম্মানীর পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_unavailable_elementsExp" id="advisor_unavailable_elementsExp" placeholder="নিজ বিশ্ববিদ্যালয়/প্রতিষ্ঠান থেকে পাওয়া যাবে না এমন উপকরণের ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_fieldWorkExp" id="advisor_fieldWorkExp" placeholder="মাঠ পর্যায়ে গবেষণার ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_seminarExp" id="advisor_seminarExp" placeholder="সেমিনার আয়োজনের জন্য ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="advisor_travelExp">ভ্রমণ ব্যয়/যাতায়াত ব্যয়<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_travelExp" id="advisor_travelExp" placeholder="ভ্রমণ ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="advisor_itemsExp">মনোহারী দ্রব্যাদি ক্রয় খাতে ব্যয় (সর্বোচ্চ ২০০০ পর্যন্ত)<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_itemsExp" id="advisor_itemsExp" placeholder="মনোহারী দ্রব্যাদি ক্রয় খাতের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="advisor_reportExp">প্রতিবেদন প্রণয়ন ও বাঁধাই ব্যয় (সর্বোচ্চ ৫০০০ পর্যন্ত)<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_reportExp" id="advisor_reportExp" placeholder="প্রতিবেদন প্রণয়ন ও বাঁধাই ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="advisor_extraExp">বিবিধ (সর্বোচ্চ ২০০০ পর্যন্ত)<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_extraExp" id="advisor_extraExp" placeholder="আরো কোনো খাতে ব্যয় হলে তার পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_sixMonthTotalExp" id="advisor_sixMonthTotalExp" placeholder="ছয় মাস মেয়াদী প্রকল্পের মোট ব্যয়ের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    ...
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_prev_economicHelp" id="advisor_prev_economicHelp" placeholder="প্রকল্পগুলোর অনুমোদনের সাল লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="advisor_economicApproval">আর্থিক মঞ্জুরীর পরিমাণ (প্রকল্প ভিত্তিক)<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_economicApproval" id="advisor_economicApproval" placeholder="আপনার আর্থিক মঞ্জুরীর পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_final_report_date" id="advisor_final_report_date" placeholder="প্রকল্পের চূড়ান্ত রিপোর্ট বিশ্ববিদ্যালয়/কমিশনে জমা দেয়ার তারিখ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_final_report_currentCondition" id="advisor_final_report_currentCondition" placeholder="চূড়ান্ত রিপোর্ট বিশ্ববিদ্যালয়/কমিশনে জমা না হলে তার বর্তমান অবস্থার বিবরণ লিখুন" required>
                        </div>
                    </div>
                    ...
                    <div class="mt-2 ms-5">
                        ...
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_economicHelping_org" id="advisor_economicHelping_org" placeholder="আর্থিক সাহায্যকারী সংস্থার নাম লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="advisor_economicHelping_project">প্রকল্পের নাম<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_economicHelping_project" id="advisor_economicHelping_project" placeholder="আপনার প্রকল্পের নাম লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="advisor_economicHelping_money">আর্থিক অনুদানের পরিমাণ<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_economicHelping_money" id="advisor_economicHelping_money" placeholder="আর্থিক অনুদানের পরিমাণ লিখুন" required>
                        </div>
                    </div>
                    <div class="mt-2 ms-5">
                        <label for="advisor_economicHelping_finishingDate">সমাপ্তির তারিখ<span class="text-danger"> *</span></label>
                        <div class="input-group mt-2">
                            <input type="text" class="form-control" name="advisor_economicHelping_finishingDate" id="advisor_economicHelping_finishingDate" placeholder="প্রকল্পের সমাপ্তির তারিখ লিখুন" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="ms-5">
                            <textarea name="long_desc10" class="long_desc" id="long_desc10" required></textarea>
                        </div>
                    </div>
