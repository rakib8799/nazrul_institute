        ...
        if (password_verify($password, $author_password)) {
            ...
            if (mysqli_num_rows($result_pass) > 0) {
                ...
                if (!empty($email_verified_at)) {
                    ...
                    $_SESSION['author_role'] = $author_role;
            ...
            echo "<p class='text-danger fw-bold text-center fs-5 mt-3'>Invalid Password</p>";
        }
    } else {
        echo "<p class='text-danger fw-bold text-center fs-5 mt-3'>Invalid Email</p>";
    }
    // }
}
// else {
...
<section>
    <div class="container my-5 d-flex justify-content-center align-items-center">
        <div class="col-md-5 col-12">
            ...
            <p class="lead" style="font-family: 'Kalpurush', Arial, sans-serif">
                প্রকল্প সাবমিট করতে লগইন করে নিন আগে, আর যদি একাউন্ট না থেকে থাকে তবে প্রথমত রেজিস্ট্রেশন করে নিন।
            </p>
