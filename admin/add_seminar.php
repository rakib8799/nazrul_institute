    ...
    if (isset($_FILES['image']['name'])) {
        ...
        if (!empty($_FILES['pdf_file']['name'])) {
            ...
            if (in_array($path_info, $arr) && !in_array($path_info3, $arr3)) {
                ...
                $insert_sql = "INSERT INTO `seminar`(`title`,`image`,`pdf_file`,`created_at`) VALUES('$title','$seminar_image_name','$pdf_file_name','$current_time')";

                $run_insert_qry = mysqli_query($conn, $insert_sql);
                if ($run_insert_qry) {
                    move_uploaded_file($notice_image_tmp_name, '../Images/seminar/' . $seminar_image_name);
            ...
            if (!in_array($path_info, $arr)) {
                ...
                $insert_sql = "INSERT INTO `seminar`(`title`,`image`,`pdf_file`,`created_at`) VALUES('$title','$seminar_image_name','','$current_time')";
    ...
    <div class="col-md-8 col-12">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            <div class="mt-3">
                ...
                <input type="text" name="title" id="title" class="form-control" placeholder="সেমিনারের শিরোনাম লিখুন" required>
            </div>
            <div class="mt-3">
