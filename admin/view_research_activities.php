                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><img src="../Images/research_activities/<?php echo $image ?>" width='50px' height='50px'></td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <a href="delete_research_activities.php?id=<?php echo $id ?>&&image=<?php echo $image; ?>&&pdf_file=<?php echo $pdf_file; ?>" class="ms-md-3 ms-2 fs-3" onclick="return confirmSubmission()"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                        <?php
                                $serial_no++;
