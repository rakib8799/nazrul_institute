...
<div class="container-fluid mt-5">
    ...
    <h3 class="text-center text-secondary fw-bold">কর্মশালা সম্পর্কে বিস্তারিত</h3>
    <div class="col">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><img src="../Images/workshop/<?php echo $image ?>" width='50px' height='50px'></td>
                                    <td>
                                        <a href="edit_work_shop.php?work_shop_id=<?php echo $id ?>&&image=<?php echo $image; ?>" class="fs-3"><i class="fa-solid fa-pen-to-square"></i></a>
                                        <a href="delete_work_shop.php?id=<?php echo $id ?>&&image=<?php echo $image; ?>" class="ms-md-3 ms-2 fs-3" onclick="return confirmSubmission()"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                        <?php
                                $serial_no++;
