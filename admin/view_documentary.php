...
<div class="container-fluid mt-5">
    <a href="add_documentary.php" class="btn btn-primary mb-5">প্রামাণ্যচিত্র সম্পর্কে তথ্য সংযুক্তি</a>
    <h3 class="text-center text-secondary fw-bold">প্রামাণ্যচিত্র সম্পর্কে বিস্তারিত</h3>
    <div class="col">
                ...
                <table id="table" class="table table-bordered table-hover text-center">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">চিত্রনাট্য ও পরিচালনা</th>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?php echo $screenplay_name; ?></td>
                                    <td><img src="../Images/documentary/<?php echo $image ?>" width='50px' height='50px'></td>
                                    <td>
                                        <a href="../Files/documentary/pdf_file/<?php echo $pdf_file ?>"><?php echo $pdf_file ?></a>
                                    </td>
                                    <td>
