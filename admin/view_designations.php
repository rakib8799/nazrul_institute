...
<div class="container-fluid mt-5">
    ...
    <h3 class="text-center text-secondary fw-bold">গুরুত্বপূর্ণ পদবিগুলো দেখা</h3>
    <div class="col">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit_designation.php?year_id=<?php echo $id ?>" class="fs-3"><i class="fa-solid fa-pen-to-square"></i></a>
                                        <a href="delete_designation.php?id=<?php echo $id ?>" class="ms-md-3 ms-2 fs-3" onclick="return confirmSubmission()"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                        <?php
                                $serial_no++;
