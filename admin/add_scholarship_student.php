    ...
    if (isset($_FILES['image']['name'])) {
        ...
        if (!empty($_FILES['pdf_file']['name'])) {
            ...
            if (!in_array($path_info, $arr)) {
                ...
                $insert_sql = "INSERT INTO `scholarship_students`(`fiscal_year`,`session_year`,`faculty`,`department`,`scholarship_student`,`image`,`pdf_file`,`created_at`) VALUES('$fiscal_year','$session_year','$faculty','$department','$scholarship_student','$scholarship_students_image_name','','$current_time')";
