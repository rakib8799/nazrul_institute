...
if (isset($_POST['add_training'])) {
    ...
    if (isset($_FILES['image']['name'])) {
        ...
        if (!in_array($path_info, $arr)) {
            ...
            $insert_sql = "INSERT INTO `training`(`title`,`details`,`image`,`created_at`) VALUES('$title','$long_desc1','$training_image_name','$current_time')";

            $run_insert_qry = mysqli_query($conn, $insert_sql);
            if ($run_insert_qry) {
                move_uploaded_file($notice_image_tmp_name, '../Images/training/' . $training_image_name);
        ...
        $insert_sql = "INSERT INTO `training`(`title`,`details`,`created_at`) VALUES('$title','$long_desc1','$current_time')";
...
<div class="container-fluid  mt-5 d-flex justify-content-center">
    <div class="col-md-8 col-12">
        <h2 class="text-capitalize text-center">প্রশিক্ষণ সম্পর্কে তথ্য সংযুক্তি</h2>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mt-3">
                <input type="submit" name="add_training" value="Add" class="btn btn-primary">
            </div>
        </form>
    </div>
</div>
