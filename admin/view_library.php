...
<div class="container-fluid mt-5">
    <a href="add_library.php" class="btn btn-primary mb-5">গ্রন্থাগার সম্পর্কে তথ্য সংযুক্তি</a>
    <h3 class="text-center text-secondary fw-bold">গ্রন্থাগার সম্পর্কে বিস্তারিত</h3>
    <div class="col">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><img src="../Images/library/<?php echo $image ?>" width='50px' height='50px'></td>
                                    <td>
                                        <a href="../Files/library/pdf_file/<?php echo $pdf_file ?>"><?php echo $pdf_file ?></a>
                                    </td>
                                    <td>
                                        <a href="edit_library.php?library_id=<?php echo $id ?>" class="fs-3"><i class="fa-solid fa-pen-to-square"></i></a>
                                        <a href="delete_library.php?id=<?php echo $id ?>&&image=<?php echo $image; ?>&&pdf_file=<?php echo $pdf_file; ?>" class="ms-md-3 ms-2 fs-3" onclick="return confirmSubmission()"><i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                        <?php
                                $serial_no++;
