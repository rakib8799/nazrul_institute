    ...
    if (isset($_FILES['image']['name'])) {
        ...
        if (!empty($_FILES['pdf_file']['name'])) {
            ...
            if (!in_array($path_info, $arr)) {
                ...
                $insert_sql = "INSERT INTO `research_activities`(`fiscal_year`,`researcher_number`,`image`,`pdf_file`,`created_at`) VALUES('$title','$long_desc1','$research_activities_image_name','','$current_time')";
