    ...
    if (isset($_FILES['image']['name'])) {
        ...
        if (!empty($_FILES['pdf_file']['name'])) {
            ...
            if (in_array($path_info, $arr) && !in_array($path_info3, $arr3)) {
                ...
                $insert_sql = "INSERT INTO `library`(`title`,`details`,`image`,`pdf_file`,`created_at`) VALUES('$title','$long_desc1','$library_image_name','$pdf_file_name','$current_time')";

                $run_insert_qry = mysqli_query($conn, $insert_sql);
                if ($run_insert_qry) {
                    move_uploaded_file($notice_image_tmp_name, '../Images/library/' . $library_image_name);
            ...
            if (!in_array($path_info, $arr)) {
                ...
                $insert_sql = "INSERT INTO `library`(`title`,`details`,`image`,`pdf_file`,`created_at`) VALUES('$title','$long_desc1','$library_image_name','','$current_time')";
...
<div class="container-fluid  mt-5 d-flex justify-content-center">
    <div class="col-md-8 col-12">
        <h2 class="text-capitalize text-center">গ্রন্থাগার সম্পর্কে তথ্য সংযুক্তি</h2>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mt-3">
                <input type="submit" name="add_library" value="Add" class="btn btn-primary">
            </div>
        </form>
    </div>
</div>
