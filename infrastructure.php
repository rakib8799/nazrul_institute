    ...
    <section style="min-height: 90vh;" class="d-flex align-items-center">
        <div class="container mt-5" data-aos="fade-up">
            ...
            <div class="row d-flex justify-content-center g-4" data-aos="fade-up-right">
                <?php
                $select_from_new_paper = "SELECT * FROM `infrastructure` ORDER BY id DESC";
                ...
                ?>
                        ...
                        <div class="col-md-4" style="min-height: 50vh;">
                            ...
                            <div class="card rounded shadow" style="min-height: 50vh;">
                                <img src="Images/infrastructure/<?php echo $image ?>" alt="vc_img" class="card-img-top" style="height: 30vh;">
                                ...
                                <div class="card-body" style="min-height: 20vh;">
                                    ...
                                    <a href="infrastructure_details.php?infrastructure_id=<?php echo $id ?>" class="text-decoration-none">বিস্তারিত পড়ুন</a>
                                </div>
                            </div>
                        </div>
                <?php
