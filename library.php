    ...
    <section style="min-height: 90vh;" class="d-flex align-items-center">
        <div class="container mt-5" data-aos="fade-up">
            ...
            <div class="row d-flex justify-content-center text-center g-4" data-aos="fade-up-right">
                <?php
                $select_from_new_paper = "SELECT * FROM `library` ORDER BY id DESC";
                ...
                ?>
                        ...
                        <div class="col-md-4" style="min-height: 10vh;">

                            <div class="card rounded shadow" style="min-height: 10vh;">
                                ...
                                <div class="card-body" style="min-height: 10vh;">
                                    ...
                                    <a href="<?php if (isset($pdf_file) && $pdf_file !== "") { ?>./Files/library/pdf_file/<?php echo $pdf_file;
                                                                                                                        } else {
                                                                                                                            ?>
library.php                                                                                                                <?php
